...
import { heroSlides as fallbackHeroSlides, type MediaItem } from "@/lib/content";
...
export function HeroSlider({ featured, slides: apiSlides = [], onPlay }: HeroSliderProps) {
  const slides = useMemo(() => {
    ...
    return [
      ...
      ...fallbackHeroSlides
        .filter((slide) => slide.id !== featured.id)
        .map((slide) => ({
          id: slide.id,
          eyebrow: "TVMIX Original",
          title: slide.title,
